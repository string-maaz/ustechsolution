...
(function ($) {
        ...
        var defaults = {
            ...
            templates:          {
                ...
                listItem:         '<li class="mentiony-item" data-item-id="">' +
                                  '<div class="row">' +
                                  '<div class="pl0 col-xs-9 col-sm-9 col-md-9 col-lg-9"><img class="_avatar_ _avatar_small" src="https://avatars2.githubusercontent.com/u/1859127?v=3&s=140">' +
                                  '<p class="title userNameMargin">Company name</p>' +
                                  '</div>' +
                                  '</div>' +
                                  '</li>',
    ...
    var MentionsInput = function (settings) {
         ...
         * @param responseData
         */
        function populateDropdown(keyword, responseData) {console.log('keyword:'+keyword);
            list.empty();
