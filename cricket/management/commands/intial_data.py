...
number_of_teams = 15
number_of_player_in_each_team = 15
...
class Command(BaseCommand):
    help = 'Initalize the database with dummy data'
    ...
    def handle(self, *args, **options):
        ...
        for z in range(number_of_matches+1):
            ...
            if not team_1 == team_2:
                match_status = random.choice(['1','2'])
                if match_status == '1':
                    winning_team = random.choice([team_1,team_2])
                else:
                    winning_team = None
                match = Match.objects.create(team1 = team_1, team2 =team_2 , match_status = match_status, winning_team = winning_team)
                self.stdout.write(self.style.SUCCESS('Successfully created Match "%s"' %str(match)))
